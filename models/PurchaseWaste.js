module.exports = (sequelize, DataTypes) => {
  const PurchaseWaste = sequelize.define('PurchaseWaste', {
  ...
  PurchaseWaste.associate = (models) => {
    PurchaseWaste.belongsTo(models.Purchase, { foreignKey: 'purchase_id', targetKey: 'id', as: 'PurchaseAssociation' });
    PurchaseWaste.belongsTo(models.Waste, { foreignKey: ['product', 'type'], as: 'WasteAssociation' });
    PurchaseWaste.belongsTo(models.Supplier, { foreignKey: 'supplier', targetKey: 'id', as: 'SupplierAssociation' });
  };
